...
* Add search function to the block list.
* Add 'enabled/disabled' filter to block list.
* Add 'Block Author' filter to block list.
...
* [Bokez](https://wordpress.org/plugins/bokez-awesome-gutenberg-blocks/)
